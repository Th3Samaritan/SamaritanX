...
_CATEGORY_VECTORS: dict[str, dict[str, str]] = {
    ...
    "security_headers": dict(AV="N", AC="H", PR="N", UI="R", S="U", C="L", I="N", A="N"),
    "hpp": dict(AV="N", AC="L", PR="N", UI="R", S="U", C="L", I="L", A="N"),
    "path_normalization": dict(AV="N", AC="L", PR="N", UI="N", S="U", C="H", I="H", A="N"),
